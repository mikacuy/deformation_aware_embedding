...
parser.add_argument('--log_dir', default='log_chair_autoencoder/', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=1024, help='Point Number [default: 2048]')
parser.add_argument('--max_epoch', type=int, default=251, help='Epoch to run [default: 201]')
...
os.system('cp train_autoencoder.py %s' % (LOG_DIR)) # bkp of train procedure
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            tf.summary.scalar('pc_loss', loss)
