...
parser.add_argument('--category', default='airplane', help='Which class')
parser.add_argument('--data_split', default = "test", help='which data split to use')

parser.add_argument('--dump_dir', default='dump_airplane_cd_neighbors_testrank/', help='dump folder path [dump]')
